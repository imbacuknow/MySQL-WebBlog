<template>
   <div id="Content" align="center">
      ...
      <v-card
         ...
         width="800" height="auto" max-height="2000"
      >
         ...
         <v-col class="mt-n7" cols="12" sm="8" md="11">
            <v-card-text align="left">{{ set_content.story }}</v-card-text>
         </v-col>

         <v-col class="my-2" cols="12" sm="5" md="8">
            <v-btn
               class="ma-2" @click="Confirm" x-large
               color="green darken-1" dark
            >
               Confirm
            </v-btn>
            <v-btn 
               class="ma-2" @click="Cancel" x-large 
...
export default {
   ...
   methods: {
      ...
      Confirm() {
         // api.put("/webblog/verify_post_id=" + this.set_content.id, this.set_content)
         api
         .put("/webblog/post/update/=" + this.set_content.id)
         .then(() => {
